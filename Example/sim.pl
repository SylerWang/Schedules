...
$wall_offset=0.5; #the window will be ($width-2*$wall_offset) wide
$ceiling_offset=0.5; #same deal, but with the ceiling. The window will be $height-$ledge-$ceiling_offset high
...
$cores=3; #for multicore processing (rcontrib runs)
$bins=4; #number of bins of Reinhart's sky subdivition.

$N_people=0; #number of people in the office

$light_max=1000; # Range of acceptable illuminance (for plotting the illuminance results)
$light_min=300; #
...
print "	Write Radiance model\n";

$scene_file="Scene";
$z7=$heigth-$ceiling_offset;
...
print "	Luminaire contribution to workplane\n";
...
print "	Luminaire contribution to control sensors\n";
...
print "	Calculate Daylithg matrix\n";
## Scene file
...
print "	Calculate View matrix over workplane\n";
...
print "	Calculate View matrix over control sensors\n";
##
...
print "	Lighting simulation (uSchedule)\n";
$light_file="Results/$ciudad-$control-$scene_file-2.txt";
